...
int rightMotor2 = 26;    // D7 - right Motor -
int rightMotor1 = 27;    // D8 - right Motor +
int leftMotor2 = 25;    // D3 - left Motor - 
int leftMotor1 = 33;    // D4 - left Motor +
int eneLeftMotor = 32;  // D6 - enable Mortor Left
...
void loop()
{
    ...
    command = checkClient ();
         ...
         if (command == "up")  forwardMotor();
         else if (command == "down") reverseMotor();
